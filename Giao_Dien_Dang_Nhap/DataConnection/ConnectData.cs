...
namespace Giao_Dien_Dang_Nhap.DataConnection
{
    internal class ConnectData
    {
        static string strConnect = "Data Source=MSI\\SQLEXPRESS;Initial Catalog=BTL_NHOM3_QLTHUVIEN;Integrated Security=True";
